...
//user
export const USERIDCHECK = "/user/idCheck";
export const USERSENDEMAIL = "/user/sendEmail";
...
export const USERCHANGEPROFILE = "/user/changeProfile";
export const USERCHANGEPWD = "/user/changePwd";
export const USERFINDID = "/user/findId";
export const USERFINDPWD = "/user/findPwd";
